import { BarChart3, CalendarCheck, Layers3, LineChart, PackageSearch, Users } from 'lucide-react';
...
const features = [
  ...
  },
  {
    ...
    description: 'Track stock in real-time, get alerts for low inventory, and simplify reordering.',
    icon: PackageSearch,
  },
  {
  ...
  },
  {
    ...
    description: 'Grow repeat business with personalized membership plans and rewards.',
    icon: Users,
  },
  {
...
export default function BusinessSolutions() {
  return (
    <section id="solutions" className="container max-w-screen-2xl py-24 md:py-32 px-4">
      <div className="mx-auto max-w-screen-xl text-center space-y-4">
        ...
        <p className="text-muted-foreground sm:text-lg max-w-3xl mx-auto">
          From customer bookings to inventory and insights — SaarthiFlow gives you the tools to save
          time and increase revenue.
        </p>
      </div>
        ...
        {features.map((feature) => (
          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-center gap-3">
              ...
              <h3 className="font-semibold text-lg sm:text-xl">{feature.name}</h3>
            </div>
